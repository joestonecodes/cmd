...
total_cinnamon_needed = (cinnamon_needed * cinnamon_cost )
total_raisans_needed = (raisins_needed * raisins_cost)
total_baking_soda = (baking_soda_needed * baking_soda_cost)
total_eggs_cost = (eggs_needed * eggs_cost)
total_vanilla_cost = (vanilla_extract_needed * vanilla_extract_cost)
total_chips_cost = (chocolate_chips_needed * chocolate_chips_cost)
total_milk_cost = (milk_needed * milk_cost)
total_cost = total_flour_cost + total_water_cost + total_yeast_cost + total_salt_cost + total_butter_cost + total_baking_powder_cost + total_cinnamon_needed + total_raisans_needed + total_baking_soda + total_eggs_cost + total_vanilla_cost + total_chips_cost + total_milk_cost
...
def calculate_total_cost(        
        ...
        total_cost = total_flour_cost + total_butter_cost + total_baking_powder_cost + total_raisans_needed + total_baking_soda + total_eggs_cost + total_milk_cost + total_sugar_cost
        print(f"Total cost to make {recipe_name}: ${total_cost:.2f}")
